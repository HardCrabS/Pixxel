...
public class FirePunch : BoostBase
{
    float fistSpeed = 6;
    ...
    public override void ExecuteBonus()
    {
        ...
        if (punchPanel == null)
        {
            punchPanel = Resources.Load<GameObject>(resourcesFolder + "Fire Punch/Punch Time Panel");
            fistPrefab = Resources.Load<GameObject>(resourcesFolder + "Fire Punch/Fist");
            punchParticle = Resources.Load<GameObject>(resourcesFolder + "Fire Punch/Punch Particle");
            selectHand = Resources.Load<GameObject>(resourcesFolder + "Fire Punch/Select_Hand");

            sfxStart = Resources.Load<AudioClip>(resourcesFolder + "Fire Punch/sfx_boosts_blackh");
            selectBoxSFX = Resources.Load<AudioClip>(resourcesFolder + "Fire Punch/sfx_boost_ironf_1");
            fistFadingIn = Resources.Load<AudioClip>(resourcesFolder + "Fire Punch/sfx_boost_ironf_2");
            fistHit = Resources.Load<AudioClip>(resourcesFolder + "Fire Punch/sfx_boost_ironf_3");
        }
